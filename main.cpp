...
int main()
{
    ...
    while (expNum <= 20)
    {
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            cout << "--------- Experimento Array " << expNum << " ---------" << endl << endl;
            Array array(b);
            while (n <= 80000)
            {
                cout << "n: " << n << endl;
                ...
                cout << "Tiempo promedio: Array - insert_right: " << fixed << setprecision(6) << tiempo_promedio
                     << " ms" << endl
                     << endl;
                ...
                tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: Array - find: " << fixed << setprecision(6) << tiempo_promedio << " ms"
                     << endl
                     << endl;
                n = n * 2;
            }
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            cout << "--------- Experimento List " << expNum << " ---------" << endl << endl;
            List list;
            n = 10000;
            while (n <= 80000)
            {
                ...
                double tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: List - insert_left: " << fixed << setprecision(6) << tiempo_promedio << " ms"
                     << endl
                     << endl;
                ...
                tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: List - insert_right: " << fixed << setprecision(6) << tiempo_promedio << " ms"
                     << endl
                     << endl;
        ...
        for (int j = 0; j < 4; j++)
        {
            ...
            cout << "--------- Experimento ListArr " << expNum << " ---------" << endl << endl;
            ListArr listArr(b);
            n = 10000;
            while (n <= 80000)
            {
                ...
                double tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: ListArr - insert_left: " << fixed << setprecision(6) << tiempo_promedio
                     << " ms" << endl
                     << endl;
                ...
                tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: ListArr - insert_right: " << fixed << setprecision(6) << tiempo_promedio
                     << " ms" << endl
                     << endl;
                ...
                tiempo_promedio = static_cast<double>(elapsed_time) / n;
                cout << "Tiempo promedio: ListArr - find: " << fixed << setprecision(6) << tiempo_promedio << " ms"
                     << endl
                     << endl;
